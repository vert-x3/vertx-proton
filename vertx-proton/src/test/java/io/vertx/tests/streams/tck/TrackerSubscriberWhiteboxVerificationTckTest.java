...
public class TrackerSubscriberWhiteboxVerificationTckTest extends SubscriberWhiteboxVerification<Tracker> {

  private static final Logger LOG = LoggerFactory.getLogger(TrackerSubscriberWhiteboxVerificationTckTest.class);
  ...
  public TrackerSubscriberWhiteboxVerificationTckTest() {
