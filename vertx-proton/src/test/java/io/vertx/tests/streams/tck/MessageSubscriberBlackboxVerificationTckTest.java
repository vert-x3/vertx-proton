 ...
 */
package io.vertx.tests.streams.tck;
...
public class MessageSubscriberBlackboxVerificationTckTest extends SubscriberBlackboxVerification<Message> {

  private static final Logger LOG = LoggerFactory.getLogger(MessageSubscriberBlackboxVerificationTckTest.class);
  ...
  public MessageSubscriberBlackboxVerificationTckTest() {
