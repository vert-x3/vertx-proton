...
public class TrackerSubscriberBlackboxVerificationTckTest extends SubscriberBlackboxVerification<Tracker> {

  private static final Logger LOG = LoggerFactory.getLogger(TrackerSubscriberBlackboxVerificationTckTest.class);
  ...
  public TrackerSubscriberBlackboxVerificationTckTest() {
